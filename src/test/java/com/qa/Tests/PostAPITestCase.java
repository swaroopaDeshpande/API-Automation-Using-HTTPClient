...
public class PostAPITestCase {
	...
	public void createUserTest() throws ClientProtocolException, IOException {
		...
		Users users=new Users("Swaroopa","Automation-Engineer");
		...
		//4.call post call method
		CloseableHttpResponse closablehttpresponse=restClient.post(apiUrl, usersJsonString, headermap);
...
//		System.out.println(responseString);
		...
		//8.convert json String to java object: Deserialization/un marshalling
